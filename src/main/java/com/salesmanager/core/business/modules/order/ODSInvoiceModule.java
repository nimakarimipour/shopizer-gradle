...
public class ODSInvoiceModule implements InvoiceModule {
  ...
  private static final String INVOICE_TEMPLATE = "templates/invoice/Invoice";
  private static final String INVOICE_TEMPLATE_EXTENSION = ".ods";
  private static final String TEMP_INVOICE_SUFFIX_NAME = "_invoice.ods";
  private static final int ADDRESS_ROW_START = 2;
  private static final int ADDRESS_ROW_END = 5;

  private static final int BILLTO_ROW_START = 8;
  private static final int BILLTO_ROW_END = 13;

  private static final int PRODUCT_ROW_START = 16;
