...
/**
 * Implementation class responsible for calculating state of shopping cart. This class will take
 * care of calculating price of each line items of shopping cart as well any discount including
...
public class ShoppingCartCalculationServiceImpl implements ShoppingCartCalculationService {
  ...
  /**
   * Method used to recalculate state of shopping cart every time any change has been made to
   * underlying {@link ShoppingCart} object in DB. Following operations will be performed by this
   * method.
   * <li>Calculate price for each {@link ShoppingCartItem} and update it.
   *
   *     <p>This method is backbone method for all price calculation related to shopping cart.
   *
