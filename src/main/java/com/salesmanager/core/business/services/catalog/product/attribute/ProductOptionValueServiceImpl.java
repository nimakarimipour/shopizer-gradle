...
public class ProductOptionValueServiceImpl
  ...
  @Autowired private PageableProductOptionValueRepository pageableProductOptionValueRepository;
  ...
  public void delete(ProductOptionValue entity) throws ServiceException {
    ...
    List<ProductAttribute> attributes =
        productAttributeService.getByOptionValueId(entity.getMerchantStore(), entity.getId());
