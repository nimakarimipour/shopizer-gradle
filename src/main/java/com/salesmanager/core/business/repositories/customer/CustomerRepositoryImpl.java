...
public class CustomerRepositoryImpl implements CustomerRepositoryCustom {
  ...
  public CustomerList listByStore(MerchantStore store, CustomerCriteria criteria) {
    ...
    String baseQuery =
        "select c from Customer as c  left join fetch c.delivery.country left join fetch c.delivery.zone left join fetch c.billing.country left join fetch c.billing.zone";
